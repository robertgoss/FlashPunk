package tests.matchers.masks 
{
	...
	/**
      ...
      */
	public class CollideMatcher extends BaseMatcher
	{
		private var _value:Object;
		
		public function CollideMatcher(value:Object) 
		{
			if (!(value is Mask))
			{
		...
		override public function describeMismatch(item:Object, mismatchDescription:Description):void
        {
            ...
            }else
            {
                mismatchDescription
					...
					.appendText(" did not collide with this mask ")
            }
        }
        ...
        {
            description
                .appendText("A mask which collides with ")
